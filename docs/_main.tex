...
\href{}{x define control flow x}
For factors 1-2, there are techniques like testing, fuzzing, \href{}{x formal verification \ldots{} x}
that try to minimize the software/hardware bugs. \href{}{x extend this \ldots{} x}
...
\href{}{x As stated by Anon: security is an arms race, no system is fully secure. x}\href{}{??}
...
\item
  \ldots{}
  \href{}{PAC + BTI discussed in Arm Specifics Section}
\end{itemize}
...
\item
  \ldots{}
  \href{}{x Also mention constant reporting x}
\end{itemize}
...
{[}x which is a popular use-case where CFI and CFA techniques are often applied x{]}.\href{}{??}
...
\href{}{x TEE arch image Arm docs 3.1's figure x}
...
\href{}{x smc call convention \ldots ARMTZ docs 5.1's figure x}
...
\href{}{x optee arch figure\ldots.arm docs 5.1.3's fig x}
...
As mentioned in \href{}{x CFA/History/CLFAT-OAT x}, attestation has rarely targeted whole programs.\href{}{??}
...
\href{}{x It is a LLVM pass\ldots{} x}
...
and adds SFI measures \href{}{x discussed in SFI x} to protect its integrity.
...
\href{}{x sfi instrumentation figure x}
