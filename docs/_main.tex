...
3 types of code elements are then instrumented {[}\citeproc{ref-cfaplus}{1}{]}:
...
secret-independent, resulting in a smaller attack surface.'' {[}\citeproc{ref-cfaplus}{1} - Section 7{]}.
