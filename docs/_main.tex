...
\item
  ...
  As for data only attacks, \sethlcolor{pink}\hl{CFA part would handle it. how? repeat this ans in \#qual eval}\sethlcolor{correctioncolor}
\item
...
\item
  ...
  \sethlcolor{pink}\hl{arm gadgets pac+bti.jpg}\sethlcolor{correctioncolor}
\item
