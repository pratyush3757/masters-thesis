...
{[}\citeproc{ref-godefroid2012sage}{13}, \citeproc{ref-kern1999formal}{15}, \citeproc{ref-luk2005dynamic}{18}--\citeproc{ref-quinlan2009source}{21}{]}
...
As stated by Bruce Schneier: Security is a process, not a product.{[}\citeproc{ref-bruceessay}{22}{]}
...
The reason for that is explained later in \hyperref[cfatechniques]{CFA techniques subsection}.
...
\subsection{Branch Target Identification (BTI)}\label{branch-target-identification-bti}
...
control flow path through the complete program.{[}\citeproc{ref-laruswpp}{16}, \citeproc{ref-blast}{25}{]}
